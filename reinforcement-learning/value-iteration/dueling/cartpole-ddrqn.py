...
class DDDRQNAgent:
    def __init__(self, state_size, action_size):
        ...
        if self.load_model:
            self.model.load_weights("./save_model/cartpole_dddrqn.h5")
    ...
    def build_model(self):
        ...
        # state value tower - V
        state_value = LSTM(16, kernel_initializer='orthogonal', recurrent_initializer='orthogonal')(state_input)
        ...
        action_advantage = LSTM(16, kernel_initializer='orthogonal', recurrent_initializer='orthogonal')(state_input)
    ...
    for e in range(EPISODES):
        ...
        while not done:
            ...
            if done:
                ...
                pylab.savefig("./save_graph/cartpole_dddrqn.png")
        ...
        # save the model
        if e % 50 == 0:
            agent.model.save_weights("./save_model/cartpole_dddrqn.h5")
